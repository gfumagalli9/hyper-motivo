...
#ifndef MOTIVO_SIMPLEMULTITHREADEDBUILDER_H
#define MOTIVO_SIMPLEMULTITHREADEDBUILDER_H
...
class SimpleMultithreadedBuilder
{
private:
...
public:
    SimpleMultithreadedBuilder(const UndirectedGraph *G, UndirectedGraph::vertex_t from_vertex,
                               UndirectedGraph::vertex_t to_vertex,
    ...
    void phase1_thread_loop [[gnu::hot]](const unsigned int thread_no, phase1_thread_state_t *states, ConcurrentWriter *writer)
    {
    ...
    void phase2_thread_loop [[gnu::hot]](const unsigned int thread_no, phase2_vertex_state_t *states, const unsigned int nstates,ConcurrentWriter *writer)
    {
...
#endif //MOTIVO_SIMPLEMULTITHREADEDBUILDER_H
