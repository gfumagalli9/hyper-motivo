...
void SimpleMultithreadedBuilder::build()
{
...
void SimpleMultithreadedBuilder::merge_and_write(ConcurrentWriter *writer, phase2_vertex_state_t *state)
{
    //Merge tables
...
void SimpleMultithreadedBuilder::phase1_thread_loop(const unsigned int thread_no, phase1_thread_state_t *states, ConcurrentWriter *writer)
{
...
void SimpleMultithreadedBuilder::phase2_thread_loop(const unsigned int thread_no, phase2_vertex_state_t *states, const unsigned int nstates, ConcurrentWriter *writer)
{
...
SimpleMultithreadedBuilder::SimpleMultithreadedBuilder(const UndirectedGraph *G, UndirectedGraph::vertex_t from_vertex,
