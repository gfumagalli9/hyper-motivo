...
public:
    ...
    //After seeing n elements the probability of returning the j-th element is
    //Pr(selecting j) * \Prod_{i=j+1}^n (1 - Pr(not selecting i) )
    //= w_j / W_j * \Prod_{i=j+1}^n (1 - w_i/W_i) = w_j / W_j * \Prod_{i=j+1}^n (W_{i-1}/W_i)
